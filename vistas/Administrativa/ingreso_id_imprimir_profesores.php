                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example"> 
                                ...
                                <?php
                                   while($row = $result->fetch_assoc()) {
                                        ...
                                        <td> <center> <input type="button" class="btn btn-danger" value="Imprimir Lista de profesores" onclick="javascript:window.open('../pdf/imprimirListaProfesores.php?id= <?php echo $id  ?>','','width=900,height=700,left=50,top=50,toolbar=yes');" />
                                        </td>                       
                                    <?php     
                                    }  
                                    $conexion->close();
