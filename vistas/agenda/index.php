<?php
 ...
 if (isset($_SESSION['usuario'])) {
  ...
  if ($_SESSION['usuario']['tipo'] != "Root" and $_SESSION['usuario']['tipo'] != "Catedratico" and $_SESSION['usuario']['tipo'] != "Admin" and $_SESSION['usuario']['tipo'] != "Propietario") {
    header('Location: ../../');
  }
...
$DateVer = date('Y/m/d', strtotime($_POST['from']));
$Datefi                    = date('d/m/Y H:i:s', strtotime($_POST['to']));
        ...
        $query="INSERT INTO agenda VALUES(null,'$titulo','$body','','$clase','$inicio','$final','$inicio_normal','$final_normal','$DateVer')";
                ...
                <div class="row">
                        <div class="page-header"><h2></h2></div>
                                <div class="pull-left form-inline"><br>
									...
									<button class="btn btn-info" onClick="window.location = '../Root/index.php';">Regresar</button>
