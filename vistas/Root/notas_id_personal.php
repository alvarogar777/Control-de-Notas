                                  ...
                                  <?php
                                   while($row = $result_ciclo->fetch_assoc()) {
                                        ...
                                        $id_asignacion_grado_seccion=$row["id_asignacion_grado_seccion"]; 
                                         echo "<td><center>" ."<a href='formulario_eliminar_recibo.php?id_recibo=$id_recibo&id_alumno=$id_alumno&id_asignacion_grado_seccion=$id_asignacion_grado_seccion' class='btn btn-primary ' role='button'>Eliminar</a>". "</center></td>";      
