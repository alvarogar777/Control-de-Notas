...
$sql_alumno = "SELECT * FROM notas_alumno na inner join alumnos al on al.id_alumno=na.id_alumno inner join pensum pe on pe.id_pensum = na.id_pensum where na.id_asignacion_grado_seccion='$id_asignacion_grado_seccion' and al.id_alumno='$id_alumno' ORDER BY na.id_alumno ASC  ";
