<?php
	...
	class PDF extends FPDF
	{
		function Header()
		{
			...
			$this->Cell(30);
			$this->Cell(120,10, 'RECIBO DE PAGOS VARIOS',0,1,'C');
	...
	$query = "SELECT * FROM recibo r inner join alumnos a on a.id_alumno = r.id_alumno inner join asignacion_grado_seccion ag on ag.id_asignacion_grado_seccion=r.id_asignacion_grado_seccion inner join tipo_pago tp on tp.id_tipo_pago = r.tipo_pago where r.id_asignacion_grado_seccion = '$id' and r.tipo_pago='$id_pago' ";
	...
	while($row = $resultado->fetch_assoc())
	{
		...
		$nombre_pago="Pago de: ".$row['nombre_pago'];
