            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="alumno.php"><i class="fa fa-edit fa-fw"></i> Alumnos</a>                  
                        </li>
                        <li>
                            <a href="catedratico.php"><i class="fa fa-edit fa-fw"></i> Catedraticos</a>                  
                        </li>
                        <li>
                            <a href="agregar_grado.php"><i class="fa fa-edit fa-fw"></i> Asignar grados</a>                  
                        </li>
                        <li>
                            <a href="asignacion_ciclo_escolar.php"><i class="fa fa-edit fa-fw"></i> Asignar Ciclo escolar</a>                  
                        </li>
                        <li>
                            <a href="ingreso_notas_id_profesor.php"><i class="fa fa-edit fa-fw"></i> Ingreso de notas</a>                  
                        </li>
                        <li>
                            <a href="ingreso_id_imprimir.php"><i class="fa fa-print fa-fw"></i> Imprimir Notas</a>                  
                        </li>
                        <li>
                            <a href="asignacion_pagos.php"><i class="fa fa-edit fa-fw"></i> Ingresar pagos varios</a>                  
                        </li>
                        <li>
                            <a href="../agenda/"><i class="fa fa-calendar fa-fw"></i> Eventos</a>    
                        </li>
                        <li>
                            <a href="copia_seguridad.php"><i class="fa fa-copy fa-fw"></i> Copia de seguridad</a>    
                        </li>
                        <li>
                            <a href="menu_reporte_financiero.php"><i class="fa fa-print fa-fw"></i> Reportes de Ingreso</a>             
                        </li>
                        ...
                        <li>
                            <a href="ingreso_id_cambio_pass.php"><i class="fa fa-edit fa-fw"></i> Cambio de contraseñas</a>    
                        </li>
