            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="pull-right form-inline"><br>
                        <button class="btn btn-info" onClick="window.location = 'ingreso_id_imprimir_alumnos.php';">Regresar</button>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example"> 
                                ...
                                <?php
                                 ...
                                 ?>
                                        <td> <center> <input type="button" class="btn btn-danger" value="Imprimir Lista de alumnos" onclick="javascript:window.open('../pdf/impimirListaAlumno.php?id= <?php echo $id  ?>','','width=900,height=700,left=50,top=50,toolbar=yes');" />
</td>     
