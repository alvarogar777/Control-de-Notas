<?php
	...
	class PDF extends FPDF
	{
		function Header()
		{
			...
			$this->Cell(30);
			$this->Cell(120,10, 'RECIBO DE INSCRIPCION DEL COLEGIO',0,0,'C');
			$this->Ln(20);
		}
	...
	$query = "SELECT * FROM recibo r  inner join alumnos a on a.id_alumno = r.id_alumno inner join asignacion_grado_seccion ag on ag.id_asignacion_grado_seccion=r.id_asignacion_grado_seccion   where r.id_recibo= '$id'";
